  ...
  final.innerHTML = `
    <section class="studio-membership-panel" data-view-event="studio_membership_view">
      <div class="studio-final-head">
        <div><p class="kicker">MEMBERSHIP ACCESS · FAIR-MARKET · FOUNDER-APPROVED</p><h3>Access should add value.<br><em>Never take away ownership.</em></h3></div>
        <p>RESET Studio membership is priced to stay accessible, commercially sustainable, and creator-fair. Membership adds access, discovery, events, education, selected discounts and routing benefits. It never transfers ownership by default, and canceling membership never cancels a separately purchased perpetual license.</p>
      </div>
      <div class="studio-tier-grid">
        <article><span>TIER 1</span><h4>Member</h4><div class="studio-tier-price"><b>$29</b><small>/ month</small></div><p>Tier 1 member library, Studio events, educational resources, selected member content and a 5% Studio service discount.</p><strong>$290 ANNUAL · APPROX. 2 MONTHS FREE</strong></article>
        <article><span>TIER 2</span><h4>Pro</h4><div class="studio-tier-price"><b>$59</b><small>/ month</small></div><p>Tier 1 + Tier 2 library access, priority routing, one private review slot and one priority Studio service request per month, plus a 10% Studio service discount.</p><strong>$590 ANNUAL · APPROX. 2 MONTHS FREE</strong></article>
        <article><span>TIER 3</span><h4>Executive</h4><div class="studio-tier-price"><b>$99</b><small>/ month</small></div><p>Full approved member library, executive-priority routing, one private review slot, two priority service requests per month, selected early access and a 15% Studio service discount.</p><strong>$990 ANNUAL · APPROX. 2 MONTHS FREE</strong></article>
      </div>
      <p class="studio-final-note">Membership pricing and entitlements are owned by RMS, not Stripe. Checkout remains intentionally unavailable until Drive grant/revoke execution is proven and Stripe is wired to the approved RMS plan IDs. Membership provides access and benefits only; copyright, publishing ownership, master ownership and perpetual licensing require separate written rights.</p>
    </section>
